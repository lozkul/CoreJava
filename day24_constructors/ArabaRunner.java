...
public class ArabaRunner {
    public static void main(String[] args) {
        day24_constructors.Araba arb1= new day24_constructors.Araba();
        ...
        day24_constructors.Araba arb2=new day24_constructors.Araba(1243,"toyota","Corolla",2008,8000);
        System.out.println(arb2);
        // Araba ozelllikler : ilanNo=1243, marka='toyota', model='Corolla', yil=2008, fiyat=8000
        day24_constructors.Araba arb3= new day24_constructors.Araba(1456,"Mercedes","S320",2000,10000);

...
public class C06_Odev {
    public static void main(String[] args) {
        ...
        /*
        basit bir işlem merkezi oluşturma.
        kullanıcıya dört tercih sunup istediğini gerçekleştirecek 4 method oluşturun.
        1- girilen tercih asal sayı mı?
        2- girilen sayı palindrom mu?
        3- girilen sayıyı tam olarak bölen tamsayıların adedi kaç?
        4- sayının rakamlar toplamı

        4 method da string sonuç dönsün.
        main methodda sonuç bir variablea kaydedilecek ve yazdırılacak
